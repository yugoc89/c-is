...
<main class="main main--works clear" id="main" role="main">
	<h2 class="works-title">Nucleus<br>of our<br>creation</h2>
	<article class="content content--works">
		<div class="work-info" id="work-info">
		</div>
		<div class="scroll-arrows scroll-arrows--archives">
		...
		<svg class="svg--grid" id="svg--grid" height="0" xmlns="http://www.w3.org/2000/svg" viewBox="342 102.89 1168 832" xml:space="preserve"><title>grid</title>
				<rect x="342" y="102.89" width="160" height="160"/>
				<rect x="510" y="102.89" width="160" height="160"/>
				<rect x="678" y="102.89" width="160" height="160"/>
				<rect x="846" y="102.89" width="160" height="160"/>
				<rect x="1014" y="102.89" width="160" height="160"/>
				<rect x="1182" y="102.89" width="160" height="160"/>
				<rect x="1350" y="102.89" width="160" height="160"/>
				<rect x="342" y="270.89" width="160" height="160"/>
				<rect x="510" y="270.89" width="160" height="160"/>
				<rect x="678" y="270.89" width="160" height="160"/>
				<rect x="846" y="270.89" width="160" height="160"/>
				<rect x="1014" y="270.89" width="160" height="160"/>
				<rect x="1182" y="270.89" width="160" height="160"/>
				<rect x="1350" y="270.89" width="160" height="160"/>
				<rect x="342" y="438.89" width="160" height="160"/>
				<rect x="510" y="438.89" width="160" height="160"/>
				<rect x="678" y="438.89" width="160" height="160"/>
				<rect x="846" y="438.89" width="160" height="160"/>
				<rect x="1014" y="438.89" width="160" height="160"/>
				<rect x="1182" y="438.89" width="160" height="160"/>
				<rect x="1350" y="438.89" width="160" height="160"/>
				<rect x="342" y="606.89" width="160" height="160"/>
				<rect x="510" y="606.89" width="160" height="160"/>
				<rect x="678" y="606.89" width="160" height="160"/>
				<rect x="846" y="606.89" width="160" height="160"/>
				<rect x="1014" y="606.89" width="160" height="160"/>
				<rect x="1182" y="606.89" width="160" height="160"/>
				<rect x="1350" y="606.89" width="160" height="160"/>
				<rect x="342" y="774.89" width="160" height="160"/>
				<rect x="510" y="774.89" width="160" height="160"/>
				<rect x="678" y="774.89" width="160" height="160"/>
				<rect x="846" y="774.89" width="160" height="160"/>
				<rect x="1014" y="774.89" width="160" height="160"/>
				<rect x="1182" y="774.89" width="160" height="160"/>
				<rect x="1350" y="774.89" width="160" height="160"/>
		</svg>
		...
		<script type="text/template" id="template--index">
			<% _.each(datums, function (data) { %>
				...
				<article class="work-item mix cate-<%= data.pure_taxonomies.categories[0].slug %> <%= data.acf.post_size %> <%= year %>">
					<div class="work-item__info">
						<h4 class="work-item__title"><%= data.title.rendered %></h4>
						<p class="work-item__category"><%= data.pure_taxonomies.categories[0].name %></p>
						<div class="work-item__desc"><%= data.excerpt.rendered %></div>
					</div>
					<div class="work-item__front">
						<a class="ajax-trigger--single" href="/works/<%= data.slug %>"></a>
						<div class="work-item__image" style="background-image: url(<%= data.featured_media %>); ">
		...
		<script type="text/template" id="template--post">
			...
			<section class="section single-post__notes">
				<div class="single-post__desc--bottom clear">
					<% if(datums.acf.url) { %>
					<p><span class="desc-heading">URL:</span><span><a href="<%= datums.acf.url %>" target="_blank"><%= datums.acf.url %></a></span></p>
					<% }; %>
